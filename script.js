...
function tela_menu() {
  ...
  React.createElement("button", { onClick: tela_empresas }, "Empresas"), /*#__PURE__*/
  React.createElement("br", null), /*#__PURE__*/
  React.createElement("hr", null), /*#__PURE__*/
...
function salvar_config() {
  ...
  if (senha_atual && senha_atual === configuracoes.senha) {
    ...
    if (senha_atual != "") {alert("senha incorreta");}
  }
...
function tela_agenda() {
  ...
  const firstDayOfMonth = moment(today).startOf('month').format('d');
  const rows = [];

  let cells = [];
  for (let i = 0; i < firstDayOfMonth; i++) {
    cells.push( /*#__PURE__*/React.createElement("td", { key: `empty-${i}` }));
  }

  for (let day = 1; day <= daysInMonth; day++) {
    const dayStr = day < 10 ? `0${day}` : `${day}`;
    const isToday = moment(`${today.format('YYYY-MM')}-${dayStr}`).isSame(moment(), 'day');
    cells.push( /*#__PURE__*/
    React.createElement("td", { key: `day-${day}`, className: isToday ? 'today' : '' },
    dayStr));



    if (cells.length === 7) {
      rows.push( /*#__PURE__*/React.createElement("tr", { key: `row-${rows.length}` }, cells));
      cells = [];
    }
  }
...
function concluir_evento(id) {
  ...
  alert(mensagem);
  eventos_concluidos.push({
    nome: evento.nome_paciente,
    data: evento.data,
    valor: evento.valor });
...
function tela_pacientes(index) {
  const empresa = empresas.find((empresa, i) => i === index);
  const pacientes = empresa.pacientes;
  ...
  React.createElement("div", { id: "box", key: index, onClick: () => tela_prontuario(index, pacientes) }, /*#__PURE__*/
  ...
  React.createElement("br", null), /*#__PURE__*/
  React.createElement("div", null, /*#__PURE__*/
  React.createElement("button", { id: "homer", onClick: tela_empresas }, /*#__PURE__*/React.createElement("img", { src: "https://cdn-icons-png.flaticon.com/512/60/60775.png" })), /*#__PURE__*/
...
function tela_novopaciente() {
  ...
  React.createElement("tr", null, /*#__PURE__*/
  React.createElement("td", { colspan: "1" }, /*#__PURE__*/
  React.createElement("select", null,
  empresas.map((empresa, index) => /*#__PURE__*/
  React.createElement("option", null, empresa.nome)))), /*#__PURE__*/



  React.createElement("td", { colspan: "2" }, "Profiss\xE3o:", /*#__PURE__*/React.createElement("input", { type: "text", placeholder: "_____________" }))), /*#__PURE__*/
...
function cad_paciente() {
  ...
  const empresa = document.querySelector('select').value;
  ...
  // Encontrar o objeto da empresa correspondente na lista de empresas
  const empresaCorrespondente = empresas.find(e => e.nome === empresa);

  // Adicionar o novo paciente à lista de pacientes da empresa correspondente
  empresaCorrespondente.pacientes.push(novoPaciente);

  // Exibir uma mensagem de sucesso na tela
  alert("Novo paciente adicionado à empresa " + empresa);

  // Atualizar a tela de pacientes
  tela_empresas();
}

function tela_prontuario(index, pacientes) {
  ReactDOM.render( /*#__PURE__*/
  React.createElement("body", null, /*#__PURE__*/
...
const empresas = [
{
  ...
  pacientes: [
  {
    ...
    rg: "11.111.111-1",
    cpf: "111.111.111-11",
    lista_med: "Remédio 1, Remédio 2",
    profissao: "Profissão 1",
    complementar: "Informações complementares 1" },

  {
    ...
    rg: "22.222.222-2",
    cpf: "222.222.222-22",
    lista_med: "Remédio 3, Remédio 4",
    profissao: "Profissão 2",
    complementar: "Informações complementares 2" }] },
...

{
  ...
  pacientes: [
  {
    nome: "Paciente 3",
    foto: "https://cdn-icons-png.flaticon.com/512/848/848043.png",
    data_nasc: "03/03/1990",
    telefone: "(33) 3333-3333",
    rg: "33.333.333-3",
    cpf: "333.333.333-33",
    lista_med: "Remédio 5, Remédio 6",
    profissao: "Profissão 3",
    complementar: "Informações complementares 3" },

  {
    ...
    rg: "44.444.444-4",
    cpf: "444.444.444-44",
    lista_med: "Remédio 7, Remédio 8",
    profissao: "Profissão 4",
    complementar: "Informações complementares 4" }] }];




function tela_empresas() {
  ReactDOM.render( /*#__PURE__*/
  React.createElement(React.Fragment, null, /*#__PURE__*/
  React.createElement("h1", null, "Empresas"),
  empresas.map((empresa, index) => /*#__PURE__*/
  React.createElement("div", { id: "box", key: index, onClick: () => tela_pacientes(index) }, /*#__PURE__*/
  React.createElement("span", null, empresa.nome))), /*#__PURE__*/
...
function tela_testes() {
  ...
  React.createElement("a", { href: "https://forms.gle/pvfXUBqz7y6JAErAA" }, "Avalia\xE7\xE3o de Sintomas de Ansiedade no Per\xEDodo")), /*#__PURE__*/
...
function tela_financeiro() {
  let qtde = eventos_concluidos.length;
  let valorTotal = 0;

  // Loop para percorrer o array eventos_concluidos e somar os valores
  for (let i = 0; i < eventos_concluidos.length; i++) {
    valorTotal += parseFloat(eventos_concluidos[i].valor.replace(',', '.'));
  }
  ReactDOM.render( /*#__PURE__*/
  React.createElement(React.Fragment, null, /*#__PURE__*/
  ...
  React.createElement("tr", null, /*#__PURE__*/
  React.createElement("td", { rowspan: "5" }, /*#__PURE__*/React.createElement("div", { id: "qt" }, qtde)), /*#__PURE__*/
  React.createElement("td", { rowspan: "5" }, /*#__PURE__*/React.createElement("div", { id: "vl" }, "R$", valorTotal.toFixed(2))), /*#__PURE__*/

  React.createElement("td", { class: "filtro" }, "Inicio do periodo")), /*#__PURE__*/
...
function grafico_quat() {
  const eventosPorMes = eventos_concluidos.reduce((acc, evento) => {
    const data = moment(evento.data, 'DD/MM/YYYY');
    const mesAno = data.format('YYYY-MM');
    if (!acc[mesAno]) {
      acc[mesAno] = { consultas: 0, valorRecebido: 0 };
    }
    acc[mesAno].consultas++;
    acc[mesAno].valorRecebido += parseFloat(evento.valor.replace(',', '.')) / 100;
    return acc;
  }, {});

  const meses = Object.keys(eventosPorMes).sort();
  const consultasPorMes = meses.map(mes => eventosPorMes[mes].consultas);
  const valoresPorMes = meses.map(mes => eventosPorMes[mes].valorRecebido.toFixed(2));
  ...
  const mixedChart = new Chart(ctx, {
    data: {
      ...
      labels: meses.map(mes => moment(mes, 'YYYY-MM').format('MMMM/YYYY')) } });
